...
def buy_menu() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        [
            [InlineKeyboardButton("🎲 Random validity · $5", callback_data="buy_random")],
            [InlineKeyboardButton("70% validity · $10", callback_data="buy_70")],
            [InlineKeyboardButton("80% validity · $15", callback_data="buy_80")],
            [InlineKeyboardButton("90% validity · $20", callback_data="buy_90")],
            [InlineKeyboardButton("100% validity · $25", callback_data="buy_100")],
...
def tier_catalog_text_and_keyboard(
    ...
    if total_bins == 0:
        text = (
            ...
            "<i>No products in this category yet.</i>\n"
            "Stock is synced from the BIN sorter (HTML tool)."
        )
        kb = InlineKeyboardMarkup(
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    photo_path = root / "assets" / "header.png"
